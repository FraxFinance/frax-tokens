...
abstract contract AddressHelperZkSync is TestBase {
    ...
    function labelConstants() public {
        ...
        vm.label(0xAf01aE13Fb67AD2bb2D76f29A83961069a5F245F, "Constants.undefined_WFRAXOFT");
        vm.label(0xc5e4A0cfef8D801278927C25fB51C1DB7b69dDFb, "Constants.undefined_REMOTEHOP");
        vm.label(0xa05E9F9B97c963B5651ed6A50Fae46625a8C400b, "Constants.undefined_REMOTEMINTREDEEMHOP");
    }
}
