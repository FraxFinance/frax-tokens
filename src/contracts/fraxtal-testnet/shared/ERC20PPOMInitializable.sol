...
contract ERC20PPOMInitializable is ERC20PermitPermissionedOptiMintable, Initializable {
    constructor(
        address _bridge,
        address _remoteToken
    ) ERC20PermitPermissionedOptiMintable(address(1), address(1), _bridge, _remoteToken, "", "") {
