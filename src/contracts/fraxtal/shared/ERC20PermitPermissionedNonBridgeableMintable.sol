...
import { ERC20PermitPermissionedOptiMintable, IERC165 } from "src/contracts/fraxtal/shared/ERC20PermitPermissionedOptiMintable.sol";
...
contract ERC20PermitPermissionedNonBridgeableMintable is ERC20PermitPermissionedOptiMintable {
    ...
    ) ERC20PermitPermissionedOptiMintable(address(1), address(0), address(0), address(0), _name, _symbol) {}
